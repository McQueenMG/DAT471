...
#SBATCH -t 00:30:00
#SBATCH -p short
#SBATCH -J matrixmult-linsearch
#SBATCH --output=assignment7prob3_%j.log
#SBATCH --ntasks=1
...
cp "assignment7prob3_${SLURM_JOB_ID}.log" "${base_dir}/output/assignment7prob3-${dataname}-${batchsize}-${querysize}.out"