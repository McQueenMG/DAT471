...
#SBATCH -t 00:30:00
#SBATCH -p short
#SBATCH -J KNN-GPU-${database}-${query_size}-b${batch_size}
#SBATCH --gpus-per-node=L40s:1
#SBATCH --output=assignment7prob5_%j.log
#SBATCH --ntasks=1
...
data="${glovesmallpath}"
query="${glovesmallquerypath}.txt"
facit="${glovesmallquerypath}_names.txt"
...
cp "assignment7prob5_${SLURM_JOB_ID}.log" "${base_dir}/output/assignment7prob5-${dataname}-${batchsize}-${querysize}.out"