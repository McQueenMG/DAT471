...
#SBATCH -t 00:30:00
#SBATCH -p short
#SBATCH -J matrixmult-GPU-linsearch
#SBATCH --gpus-per-node=L40s:1
#SBATCH --output=assignment7prob4_%j.log
#SBATCH --ntasks=1
...
cp "assignment7prob4_${SLURM_JOB_ID}.log" "${base_dir}/output/assignment7prob4-${dataname}-${batchsize}-${querysize}.out"