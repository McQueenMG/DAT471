...
for filename in os.listdir(output_dir):
    if filename.startswith('assignment4prob2-large-') and filename.endswith('.out'):
...
plt.title('Empirical Speedup vs. Number of Cores (Large Dataset)', fontsize=14)
...
plt.tight_layout()
output_file = os.path.join(output_dir, 'prob2_speedup_plot.png')
plt.savefig(output_file, dpi=300)
print("Speedup plot saved to output/prob2_speedup_plot.png")
